...
ActiveRecord::Schema.define(:version => 20121117210155) do
  ...
  create_table "plants", :force => true do |t|
    ...
    t.text   "SeedSpreadRate"
    t.text   "SeedlingVigor"
    t.text   "SmallGrain"
    t.text   "VegetativeSpreadRate"
    t.text   "Berry_Nut_Seed_Product"
    t.text   "ChristmasTreeProduct"
    t.text   "FodderProduct"
    t.text   "FuelwoodProduct"
    t.text   "LumberProduct"
    t.text   "NavalStoreProduct"
    t.text   "NurseryStockProduct"
    t.text   "PalatableBrowseAnimal"
    t.text   "PalatableGrazeAnimal"
    t.text   "PalatableHuman"
    t.text   "PostProduct"
    t.text   "ProteinPotential"
    t.text   "PulpwoodProduct"
    t.text   "VeneerProduct"
    t.datetime "created_at",                                                   :null => false
    t.datetime "updated_at",                                                   :null => false
  end
